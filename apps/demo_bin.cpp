...
struct KinFuApp
{
  ...
  KinFuApp(BinSource& source) : exit_ (false),  iteractive_mode_(false), capture_ (source), pause_(false) {
...
int main (int argc, char* argv[])
{
  ...
  KinFuParams my_params = KinFuParams::default_params();
  my_params.volume_dims = Vec3i::all(768);
  my_params.volume_size = Vec3i::all(0.4f);
